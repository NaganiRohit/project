...
export default function BackgroundGradientDemo() {
  return (
    <div className="mx-1">
      <BackgroundGradient className="rounded-[22px] h-auto max-w-sm p-4 sm:p-10 bg-white dark:bg-zinc-900">
        {/* <Image
          src={`/jordans.webp`}
          alt="jordans"
          height="400"
        ...
        <p className="text-[0.9rem] text-neutral-600 dark:text-neutral-400">
